...
class ColorMapCreator:
    ...
    def __init__(self, RGB1, RGB2, numColors = 9., divide = 255., 
    ...
    def generateColorMap(self, RGB1, RGB2, divide):
        ...
        # calculate
        scalars = np.linspace(0., 1., int(self.numColors))
        RGBs = np.zeros((int(self.numColors), 3))
...
def main():
    ...
    # options
    # simple printout
    # colormap = ColorMapCreator(RGB1, RGB2, numColors=9).generateColorMap(RGB1, RGB2, divide=255)
