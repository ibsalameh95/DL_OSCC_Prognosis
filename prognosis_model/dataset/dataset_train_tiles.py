...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, slide_id=None, slide_list_filename=None, cz_imgs_list= None, he_imgs_list= None, num_instances=16, dataset_type='train', imgs_type= None):
        ...
        self._image_transforms = self.image_transforms() #torchvision.models.ResNet50_Weights.IMAGENET1K_V2.transforms() # self.cz_image_transforms()  # torchvision.models.ResNet50_Weights.IMAGENET1K_V2.transforms() #
    ...
    def extract_overlapping_tiles(self, image, tile_size=(32, 32), stride=(32, 32)):
