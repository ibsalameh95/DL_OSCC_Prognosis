...
parser.add_argument('--init_model_file', default='Results/prognosis_model/saved_models/model_weights__2024_04_28__14_21_37__107.pth',help='Initial model file (optional)', dest='init_model_file')
parser.add_argument('--slide_list_filename', default='prognosis_model/Data/seg2/test_attribution.txt', help='slide list test', dest='slide_list_filename')
...
with torch.no_grad():
    ...
    for s, slide_id in enumerate(slide_ids):
        ...
        out_dir = '{}/{}/{}'.format(FLAGS.attribution_dir,model_name,slide_id)
        ...
        for images, targets, cz_img_paths, he_img_paths in data_loader:
            ...
            for k in range(10):
                ...
                for instance in range(num_instances):
                    if FLAGS.imgs_type == 'HE':
                        ...
                        blurred_image = original_image.filter(ImageFilter.BoxBlur(radius=5))
                ...
                attr = ig.attribute(images, baselines= baseline_tensor.cuda(images.get_device()), target=targets, n_steps=20, return_convergence_delta=False) 
            ...
            for instance in range(num_instances):
                ...
                np.save('{}/{}__img.npy'.format(out_dir, instance),img_arr)
                np.save('{}/{}__attribution.npy'.format(out_dir, instance),attr_arr_mean_instance)